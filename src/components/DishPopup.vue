    ...
    <div class="flex flex-col justify-between w-full gap-3">
      ...
      >
        <div class="flex flex-col md:flex-row items-start md:items-center">
          ...
          <div class="flex flex-wrap items-center">
            <template
              v-for="(tag, index) in dish.processedTags?.allergens"
              :key="tag + '-' + index"
            >
              <div
                v-if="tag"
          ...
          <div>
            ...
            <div class="flex flex-col justify-between items-end h-full w-full">
              ...
              >
                ...
                <button
                  @click="resetBtn(dish)"
                  class="btn btn--secondary btn--small flex items-center justify-center bg-[url('reset.svg')] bg-no-repeat bg-center bg-auto w-10 h-10 md:w-12 md:h-12"
